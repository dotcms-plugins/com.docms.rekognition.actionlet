...
package com.dotcms.rekognition.util;
 ...
 */
public class AWSPropertyBundle {
    private static final String PROPERTY_FILE_NAME = "aws-rekog.properties";
    private static Properties properties;
    static {
        properties = new Properties();
        try {
            InputStream in = AWSPropertyBundle.class.getResourceAsStream("/" + PROPERTY_FILE_NAME);
            if (in == null) {
                in = AWSPropertyBundle.class.getResourceAsStream("/com/dotcms/rekognition/util/" + PROPERTY_FILE_NAME);
                if (in == null) {
